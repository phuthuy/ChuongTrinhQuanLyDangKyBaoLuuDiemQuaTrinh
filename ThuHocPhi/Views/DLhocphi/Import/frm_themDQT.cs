...
{
    public partial class frm_themDQT : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                var rs = dqt_ctrl.InsertDuLieu(txt_masv.Text, textBox2.Text, textBox3.Text, textBox4.Text, textBox5.Text, textBox6.Text, textBox8.Text);//comboBox1.SelectedValue);
                switch (rs.ErrCode)
                {
                    case CEnum.Success:
